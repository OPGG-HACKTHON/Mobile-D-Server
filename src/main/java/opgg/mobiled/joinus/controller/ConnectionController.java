...
public class ConnectionController {
    ...
    public List<User> selectConnectionWithStartAndIsFriend(@RequestParam @ApiParam(value = "관계를 등록한 사람", required = true) int start_id, @RequestParam @ApiParam(value = "친구(true)/블랙(false)", required = true) boolean friend_or_black){
